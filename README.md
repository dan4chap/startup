...
- [x] **All functionality implemented or mocked out** - Localstorage used to track user and use login. There is mock storage usage for what will be info pulled from DB. There is also functionality for adding goals and mock chatting.
